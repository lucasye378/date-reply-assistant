...
export default function Home() {
  ...
  const handleUseThis = (option: ReplyOption) => {
    ...
    setCustomReply(""); // Clear custom reply, show confirmation step first
  };
  ...
  return (
    <main className="min-h-screen bg-gradient-to-b from-pink-50 to-white">
      ...
      <div className="max-w-lg mx-auto px-6 py-8">
        ...
        {/* Confirmation Step */}
        {selectedOption && !customReply && (
          <div className="mb-4 p-4 bg-pink-50 border border-pink-200 rounded-2xl text-center">
            <p className="text-gray-800 mb-3">This looks good? 👍</p>
            <div className="flex gap-3">
              <button
                onClick={() => setCustomReply(selectedOption.text)}
